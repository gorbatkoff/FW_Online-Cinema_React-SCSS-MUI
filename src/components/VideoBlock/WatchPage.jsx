  ...
  return (
    <div className={styles.player}>
      ...
      <div className={styles.video}>
        <div id="player"></div>
        <Player id="player" file="https://plrjs.com/sample.mp4" noControls/> 
...
function PlayNewVideo() {
  if (window.pljssglobal.length > 0) {
    window.pljssglobal[1].api("play", "https://youtu.be/WYHzQExWGGc");
  }
}

function startPlayer() {
  if (window.pljssglobal.length > 0) {
    window.pljssglobal[1].api("toggle");
  }
}

function stopPlayer() {
  if (window.pljssglobal.length > 0) {
    window.pljssglobal[1].api("stop");
  }
}